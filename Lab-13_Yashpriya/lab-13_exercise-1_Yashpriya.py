### Implement bagging regressor using scikit-learn. Use diabetes dataset from scikit-learn.
...
# Training the model -
bag_reg = BaggingRegressor(estimator=DecisionTreeRegressor(max_depth=3), n_estimators=100, max_features=1.0, max_samples=1.0, bootstrap_features=False, bootstrap=True, random_state=42, n_jobs=-1)
